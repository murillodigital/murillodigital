...
This basic tenet speaks volumes on the relevance of understanding and dedicating targeted effort in enabling those groups of people to efficiently work as a collective.
...
It is safe to fail, you are not alone and we're in this together. Create connection. We are wired to look for safety in groups.
...
People are moved to do more if they know somebody's got their backs, and they will not be reckeless when they know others are just as dependent on them.

Building a culture of safety requires cues delivered consistently and over time, its a narrative that must be ever present.

### How does one build belonging

Closeness and connection, and problem solving together. Nothing builds cohesion in a group like having to solve problems and struggle, together. And the leader should be candid, direct yet present and caring for her team.
...
A leader should provide perspective, a big picture view of the world, and establish connection outside the tasks at hand, relationships are built both in and around the professional development of the team.

### Designing for belonging

In the words of Tony Hsieh, Zappos founder, create environments and model interactions that bring forth many opportunities for meaningful "collisions". Collisions are instances where people can bump into one another.

An experiment performed by the US during the cold war to evaluate why some teams succeeded and others did not in research and development of new technologies and weapons demonstrated something surprising, the one consistent difference across between successful teams vs those that were not, was the distance at which they sat. Closer means more communication, and more communication means a stronger sense of belonging and more ideas. This concept is known as the [Allen Curve]
...
Every one of the cultures studied in [_The Culture Code_](https://amzn.to/2GogAZF) promote moments of intense vulnerability:
...
Leaders should clearly signal their own vulnerability. These signals of vulnerability creates a virtuous cycle where each signal promotes others to also express their own signals, and in every iteration, increase the closeness and trust of the group.
...
The other aspect of enabling cooperation and sharing vulnerability is providing teams with the autonomy to cooperate, to think for themselves.

Being vulnerable together allows teams to challenge each other, and trust each other as equals. This goes against the norm of deferring to some authority. The leader should generate a series of signals that influence the team away from the natural tendency of following authority mandates, and into new tendencies for interdependence and cooperation.
...
The last piece of the puzzle, after having built a safe environment, where people feel they belong and can share the risk and vulnerability, is to answer the question: _What are we working towards?_.

Defining a mission is not subtle amongst the studied high performing groups, the beliefs and mission that define purpose are ever present across all facilities, interactions and communications.
...
# Developing for proficiency and creativity require different approaches

Most teams will require a combination of both proficiency (doing a task with extreme reliability every time where the goal behaviors can be clearly defined), and creativity (building something that has never existed before). Each of these two different types of development require different mechanisms to promote excellence.
...
On the other hand, the actions a leader must take in order to build a culture skilled in creativity should focus on the team composition and dynamics, the team's autonomy and the team's tolerance and acceptance to failure and feedback. The leader should encourage initiative and establish routines of celebration when team members demonstrate independence and candidness.



# The impact of remote work in culture



A lot of the characteristics in terms of behavior from teams that demonstrate strong cohesiveness and an environment that is safe and full of trust are dependent on physical proximity.

Touch, eye contact, lots of energetic and unstructured exchanges. What does this mean in the context of remote team work?

# Some numbers that demonstrate the importance
